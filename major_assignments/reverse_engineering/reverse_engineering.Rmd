...
* **Analysis summary**: I was able to confirm both findings. Moore was found to have raised over $\$2.3$ million from out of state, and Perez almost $\$1.7$ million as the story states.
...
* **Analysis summary**: King raised a total of $~\$2.2$ million. $\$238,339$ came from MD, and $\$534,478$ came from NY. The ratio of MD donations is $~11\%$ of total donations
...
* **Analysis summary**: This is confirmed, as Franchot raised $\$1,304,121$ of his total $\$1,663,516$ contributions from Maryland. This comes out to 78% of total contributions from Maryland. Unsure why they used the language for "over 78%" when it comes out to 78.4% according to this data and how it is coded here. 
...
* **Analysis summary**: Perez raised a total of $\$2,458,688$, with $\$760,794.4$coming from MD. This comes out to 31% of his donations coming from Maryland donors, and aligns with the story. 
