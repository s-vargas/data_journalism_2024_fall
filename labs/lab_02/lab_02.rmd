...
md_voters_2024$new_reg <- ifelse(md_voters_2024$STATE_REGISTRATION_DATE == md_voters_2024$COUNTY_REGISTRATION_DATE,1,0) # creating a new dummy var that indicates new voters based on given definition
