...
md <- get_acs(geography = "county",
              variables = c(sexbyage = "B01002A_001"),
              state = "MD",
              year = 2022)
```
...
**A1**
Baltimore City has the lowest median age with 36.8 years old.
```{r}
md |> 
  arrange(estimate)
```
...
**A2**
Dorchester county, Kent County, Worcester County, and Talbot county all have median
ages of at least 50. 
```{r}
md |> 
  filter(estimate >= 50)|> 
...
fred_ages |>
  mutate(NAME = gsub(" ZIP, Maryland", "", zipcode)) |>
