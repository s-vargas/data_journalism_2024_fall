...
```{r echo=FALSE}
census_api_key("7cd87e22bac185cc7a4cf64febec794690b90213", install=TRUE)
```
...
Calvert county's median income matches up to Montgomery county's high. It looks like 
MoCo's range fits in to Calvert's, with Calvert having a higher/larger range.

Is the difference between Howard and everyone else significant? **Answer**
Howard county's range and median is much higher than all other counties in this visualization. 
...
**Answer**
Of 20 largest totals those with <$50k median:
- 21202 with median = $47,848
...
How diverse are these individual zip codes in terms of counties? Are most of these high 
median income zips in the same few counties? Or are some zipcodes outliers from
the top counties as wholes?
