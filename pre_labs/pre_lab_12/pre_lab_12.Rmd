...
The sentiment analysis seems pretty accurate. We do have concerns with words like "work", 
"well", "critical" for issues around context in the actual release could be 
different than the sentiment analyzed.  
```{r}
