...
**Answer**
A lot of inconsistencies in the recipient naming. W Millar, W. MILLAR, W.Millar, W. Millar
```{r}
...
**Answer**
Turned SCARLET OAK into Scarlet Oak
```{r}
...
W Millar Catering	= W. MILLAR & CO. CATERING
Walmart	= WALMART
```{r}
cleaned_dc_food |>
...
**Answer**
The changes made here are even closer to consistent formatting. W. Millar has consolidated to two names:
W. MILLAR & CO. and	W. MILLAR & CO. CATERING. This is down from several. The Walgreens, Walmart, and Hilton
are also examples of locations that are getting consolidated and closer to cleaner. 
```{r}
cleaned_dc_food <- dc_food |>
